...
const MUTATIONS = [
  ...
  ['M24', 'Speed tiers: the neutral-nature Scarf column is computed from the boosting figure',
    "{key:'scarfn', label:'Neutral +32 + Scarf', hint:'32 SP, neutral nature, Choice Scarf', f:b=>Math.floor((b+20+32)*1.5)}",
    "{key:'scarfn', label:'Neutral +32 + Scarf', hint:'32 SP, neutral nature, Choice Scarf', f:b=>Math.floor(Math.floor((b+20+32)*1.1)*1.5)}",
